                ...
                {this.state.timeSlots.length !== 0 ? (
                    <React.Fragment>
                        ...
                        <div id="timeslot-container">  
                            ...
                            {this.state.timeSlotsSlice.map((timeSlot, i ) => <button className={this.state.id === i? "timeslot btn timeSlotSelected": "timeslot btn"} key={i} value={timeSlot} onClick={() => this.handleTimeSlotClick(timeSlot,i)}>{timeSlot}</button>, i++)}
                        </div>
